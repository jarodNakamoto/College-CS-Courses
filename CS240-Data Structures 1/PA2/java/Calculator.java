...
// TODO (Student): your fields here
  ...
  */
  public Double solve(String equation) {
     ...
     StringTokenizer parts = new StringTokenizer(equation,"+-/()* ",true);
     ...
     while(parts.hasMoreTokens())
     {
        ...
        else if(str.equals(")"))
        {
            ...
            {
                numbers.push(popStackAndSolve(numbers, operators));
            }
            operators.pop();
        }
           ...
           || str.equals("-"))
	    {
           ...
           while(!operators.empty()  && !hasPrecedence(operators.peek(),op))
           {
               double temp = popStackAndSolve(numbers, operators);
               numbers.push(temp);
            }
           operators.push(new Character(op));
        }
        else
        {
           // is a number
    ...
    return Double.parseDouble(formatter.format(numbers.pop()));
  }
}
